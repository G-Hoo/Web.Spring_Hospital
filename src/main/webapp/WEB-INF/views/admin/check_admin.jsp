...
<!-- content begin -->
	<div class="container_bulb margin_center text_center" style="width:300px">
		<input type="button" value="bulbon" ondblclick="bulbOn()">
		<img id="bulb" src="../../images/admin/bulboff.gif">
		<input type="button" value="bulboff" onclick="bulbOff()">
	</div>
	<div class="text_center">
		<h3 id="greetingadmin"></h3>
		<img class="display_none" id="testimg" style=width:200px src="../../images/staff/1.png">
	</div>
</div>
...
<script>
	function bulbOn() {
		document.getElementById('bulb').src="../../images/admin/bulbon.gif";
		document.getElementById('greetingadmin').innerHTML="HI ADMIN";
		document.getElementById('testimg').style.display='inline-block';
	}
	function bulbOff() {
		document.getElementById('bulb').src="../../images/admin/bulboff.gif"
		document.getElementById('greetingadmin').innerHTML="BYE ADMIN"
